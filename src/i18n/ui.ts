...
const ui = {
  ...
  'duel.lead': {
    ru: 'Создай комнату, кинь ссылку другу — и угадывайте одного и того же персонажа наперегонки.',
    uk: 'Створи кімнату, кинь посилання другу — і вгадуйте одного й того самого персонажа наввипередки.',
    en: 'Create a room, send the link to a friend and race to guess the same character.',
  },
  'duel.rules': {
    ru: 'На угадывание 10 минут. Как только один угадал, у второго остаётся минута. Побеждает тот, кто угадал; если оба — у кого меньше попыток, при равенстве — кто быстрее.',
    uk: 'На вгадування 10 хвилин. Щойно один вгадав, у другого лишається хвилина. Перемагає той, хто вгадав; якщо обидва — у кого менше спроб, за рівності — хто швидше.',
    en: 'Ten minutes to guess. Once one player solves it, the other has one minute left. The solver wins; if both solve, fewer guesses wins, then the faster time.',
  },
  ...
  'duel.waitRival': { ru: 'Ты угадал! Ждём соперника — у него осталась минута.', uk: 'Ти вгадав! Чекаємо суперника — у нього лишилася хвилина.', en: 'You solved it! Waiting for your rival — they have a minute left.' },
