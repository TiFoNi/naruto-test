  ...
  return (
    <div className="app">
      ...
      <footer>
        ...
        <p>
          {t('footer.data')}: Naruto Wiki, Dattebayo API, Valve, OpenDota, Dota 2 Wiki, Attack on Titan Wiki, Bleach Wiki, Tokyo Ghoul Wiki, Berserk Wiki, Kimetsu no Yaiba Wiki, Blue Lock Wiki, One Piece Wiki, MyAnimeList.
        </p>
      </footer>
    </div>
  )
