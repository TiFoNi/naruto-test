...
const ui = {
  ...
  'profile.questsSoon': { ru: 'Небольшие цели на каждый день с наградой за все сразу.', uk: 'Невеликі цілі на кожен день із нагородою за всі одразу.', en: 'Small daily goals with a reward for finishing them all.' },
